...
def generate_positive_pairs(df: pd.DataFrame, max_pairs_per_item: int = 3):
    examples = []
...
def build_faiss_index(model: SentenceTransformer, df: pd.DataFrame):
...
def main():
    ...
    # Build searchable index on full dataset for the demo
